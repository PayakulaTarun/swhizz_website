...
const PlacementsPage: React.FC<PlacementsPageProps> = ({ onBack, onEnroll, onContact, theme }) => {
  ...
  const eliteAlumni = [
    ...
    { name: "Ananya Iyer", company: "Google", quote: "Elite mentorship and a direct referral network. Swhizz isn't just a training center; it's a career launchpad.", course: "Cybersecurity", img: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&q=80&w=200" },
        ...
        <div className="max-w-7xl mx-auto mb-20 reveal">
          <div className="flex flex-col md:flex-row justify-between items-end gap-10">
             <div className="space-y-4">
               ...
               <h3 className="text-4xl sm:text-7xl font-display font-bold text-slate-900 dark:text-white italic tracking-tighter">Elite Feedback.</h3>
             </div>
